      ...
      <Container maxW="container.xl" py={12}>
        ...
        >
          <VStack align={{ base: 'center', md: 'flex-start' }} spacing={4}>
            <Text fontSize="lg" fontWeight="semibold" bgGradient="linear(to-r, brand.400, purple.400)" bgClip="text">
              BOLTICK
            </Text>
          ...
          <HStack spacing={6}>
            <Link href="#" color="whiteAlpha.600" _hover={{ color: 'brand.400' }} transition="color 0.2s">
              <Facebook size={18} />
            </Link>
            <Link href="#" color="whiteAlpha.600" _hover={{ color: 'brand.400' }} transition="color 0.2s">
              <Twitter size={18} />
